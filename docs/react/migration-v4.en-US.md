...
We provide a codemod cli, [@ant-design/codemod-v4](https://github.com/ant-design/codemod-v4), a collection of codemod scripts that help upgrade antd v4 using [jscodeshift](https://github.com/facebook/jscodeshift).
...
`@ant-design/codemod-v4` will help you migrate antd v4, `@ant-design/compatible` is the workaround for the deprecated APIs and components , so you don't need do it yourself in general. The blew content are introduction for the migration in detail.
