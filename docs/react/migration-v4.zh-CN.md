...
我们提供了 codemod cli 工具，[@ant-design/codemod-v4](https://github.com/ant-design/codemod-v4), 帮助你快速升级到 v4 版本，基于 [jscodeshift](https://github.com/facebook/jscodeshift) 构建。
...
`@ant-design/codemod-v4` 会帮你迁移到 antd v4, 废弃的 API 和组件则通过 `@ant-design/compatible` 保持运行, 因此一般来说你无需手动迁移。下面的内容主要描述了迁移的详情情况。
